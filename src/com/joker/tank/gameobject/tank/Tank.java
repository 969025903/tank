package com.joker.tank.gameobject.tank;
...
import com.joker.tank.gameobject.explode.general.TankExplode;
...
import com.joker.tank.strategy.tankai.TankAiStrategy;
import com.joker.tank.strategy.tankai.impl.DefaultTankAiStrategy;
...
public abstract class Tank extends GameObject {
    ...
    // 打印当前子弹
    protected void paintNowFireStrategy(Graphics g) {
        // 如果没有子弹，返回
        if (fireStrategies.size() == 0) return;
    ...
    // 打印改变的生命值
    public void paintHealthChange(Graphics g) {
    ...
    public int getNowFireStrategy() {
        return nowFireStrategy;
    }

    public void setNowFireStrategy(int nowFireStrategy) {
        this.nowFireStrategy = nowFireStrategy;
    }
    ...
    public ArrayList<FireStrategy> getFireStrategies() {
        return fireStrategies;
    }
    ...
    public void setMovingCnt(int movingCnt) {
        this.movingCnt = movingCnt;
    }

    public void setPeneCnt(int peneCnt) {
        this.peneCnt = peneCnt;
    }
