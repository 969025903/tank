package com.joker.tank.gameobject.tank.special;
...
import com.joker.tank.strategy.fire.general.DefaultFireStrategy;
import com.joker.tank.strategy.fire.general.MidMissileFireStrategy;
...
public class CrabTank extends Tank {
    ...
    public CrabTank(int x, int y, Group group, GameModel gm) {
        ...
        randomDir();
        // 添加默认子弹
        addFireStrategy(new MidMissileFireStrategy(10000));
    }
