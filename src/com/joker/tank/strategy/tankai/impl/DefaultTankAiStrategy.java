package com.joker.tank.strategy.tankai.impl;

import com.joker.tank.chainres.collide.impl.ExplodeCollider;
...
public class DefaultTankAiStrategy implements TankAiStrategy {
    ...
    public void tankAiChangeFire(GameModel gm, Tank tank) {
        if (random.nextInt(1000) > 995) tank.changeFireStrategy();
    }
}
